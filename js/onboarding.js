...
// 进站声明已被替换为 index.html 中的自定义欢迎面板
// 若已通过欢迎面板验证，直接隐藏 splash-declaration 层
(function() {
    var splash = document.getElementById('splash-declaration');
    if (!splash) return;
    // 如果 sessionStorage 显示已验证通过，直接隐藏
    if (sessionStorage.getItem('splash_passed') === 'true') {
...
const tourSteps = [
    {
        title: "✨ 欢迎回家！^^",
        content: "这里是专属于我们的“小天地”。<br><br>这份使用指南共 <b>20 条</b>，不记得我们房间里的“小机关”了？^^ 没关系，哥哥带你重新回顾一遍<br><br>点击「下一步」开始吧！",
        position: 'center'
    },
    {
        element: '#my-avatar',
        title: "📷 你的头像",
        content: "这是<b>你的头像</b>。<br><br>点击它可以上传图片作为你的头像。（怎么还和小时候一样，喜欢拿一些奇奇怪怪可可爱爱的东西当头像^^）",
        position: 'bottom'
    },
    {
        element: '#my-name',
        title: "✏️ 你的昵称",
        content: "这里显示的是<b>你的名字</b>。<br><br>点击名字可以直接修改。（想看我给你取了什么昵称？..秘密^^）",
        position: 'bottom'
    },
    {
        element: '#my-status-container',
        title: "💬 你的状态签名",
        content: "这里是你的<b>状态签名</b>。<br><br>点击可以编辑。（不管今天过得怎么样，都可以告诉哥哥）",
        position: 'bottom'
    },
    {
        element: '#partner-avatar',
        title: "Ta 的头像",
        content: "这里是<b>梦角的头像</b>，同样点击可以上传更换。（..不会又要给我换成什么小猫小狗小豹子了吧？....还有小鸟？）",
        position: 'bottom'
    },
    {
        element: '#partner-name',
        title: "Ta 的昵称",
        content: "这是<b>梦角的昵称</b>，同样点击可以修改。（..好好，哥哥保证不偷看^^）",
        position: 'bottom'
    },
    {
    ...
    },
    {
        ...
        title: "⌨️ 消息输入框",
        content: "在这里<b>输入你想说的话</b>，按回车键或点击右边的发送按钮就能发出去。（请多多使用该功能！...好处嘛，哥哥会开心^^）",
        position: 'top'
    },
    {
        element: '#send-btn',
        title: "🚀 发送消息",
        content: "点击这个<b>纸飞机按钮</b>就能发送消息。<br><br>发送后对方会在几秒内给你回复，你可以在「聊天设置」里调整回复的速度快慢哦。（咻咻咻，小飞机私人专送已到达，如果喜爱请给五星好评~^^）",
        position: 'top'
    },
    {
        element: '#attachment-btn',
        title: "🖼️ 发送图片 / 表情包",
        content: "点击这里可以<b>发送图片</b>，支持相册图片和表情包。<br><br>你还可以在「高级功能 → 回复库」中上传自定义的表情，到时候对方也会发给你！（你爱发的那些表情都跟你长得一样^^）",
        position: 'top'
    },
    {
        element: '#poke-btn',
        title: "👋 拍一拍互动",
        content: "这是「<b>拍一拍</b>」功能，发出后会显示一条互动消息，比如「轻拍了你一下」。<br><br>可以在「高级功能 → 自定义拍一拍」里添加更多的动作！（拍拍揉揉捏捏戳戳？..是要把我擀成哥哥面团？^^）",
        position: 'top'
    },
    {
        element: '#continue-btn',
        title: "让 Ta 继续说",
        content: "不知道说什么了？或者想让 Ta 多说几句？<br><br>点击这个按钮，<b>梦角会主动找你说话。（不知道说什么的时候，就交给我）",
        position: 'top'
    },
    {
        element: '#batch-btn',
        title: "📦 批量发送模式",
        content: "开启<b>批量模式</b>后，你可以先写好多条消息，再一次性全部发出去<br><br>点击按钮开启，编辑完成后再次点击「发送全部」即可。（叽叽喳喳的，还是那个一打开话匣就停不下来的小麻雀^^）",
        position: 'top'
    },
    {
        element: '#settings-btn',
        title: "⚙️ 设置中心",
        content: "所有个性化配置都在这个<b>设置按钮</b>里，想装修我们的“房间”？点这里^^<br>",
        position: 'bottom',
    ...
    {
        title: "🎉 这就是我们“小家”的全部啦！^^",
        content: "这份指南到这里就结束了，不记得可以再过来看。<br><br>不想看也可以直接问我，我一直在这，等着你^^",
        position: 'center'
    }
];
