...
var festivals = [
    { m:1, d:1, name:'元旦', emoji:'🎆', label:'NEW YEAR', note:'元旦快乐！今晚游灯，一起去看吗？^ ^' },
    { m:1, d:5, name:'小寒', emoji:'❄️', label:'MINOR COLD', note:'今天小寒，冷不冷？过来，哥哥给你暖暖手^^' },
    { m:1, d:20, name:'大寒', emoji:'🧊', label:'MAJOR COLD', note:'大寒快乐，记得添衣保暖。还有我们的围巾，别忘了~' },

    { m:2, d:4, name:'立春', emoji:'🌱', label:'START OF SPRING', note:'立春快乐！春天来了，今年想去哪里看花？❀' },
    { m:2, d:14, name:'情人节', emoji:'💝', label:'VALENTINES DAY', note:'情人节快乐❤ 给你的东西收到了吗？嗯，听到了，我也爱你。' },
    { m:2, d:16, name:'除夕', emoji:'🧧', label:'CHINESE NEW YEAR EVE', note:'除夕快乐！又吃撑了？^^ 今夜也准备要一起守岁吗？' },
    { m:2, d:17, name:'春节', emoji:'🎊', label:'SPRING FESTIVAL', note:'新年快乐！新的一年，愿你平安喜乐。我在这里，往后每天每年，也都如此。' },
    { m:2, d:18, name:'雨水', emoji:'☔', label:'RAIN WATER', note:'雨水节气，你那边也下雨了吗？记得带伞🌂' },

    { m:3, d:3, name:'元宵节', emoji:'🏮', label:'LANTERN FESTIVAL', note:'元宵节快乐！花灯好美，不过，最美的还是你眼里那盏。吃过元宵了吗？我煮了好多。..嗯，都是你的。^ ^' },
    { m:3, d:5, name:'惊蛰', emoji:'⚡', label:'AWAKENING OF INSECTS', note:'惊蛰春雷响，万物复苏，你是我最美的春天。' },
    { m:3, d:8, name:'妇女节', emoji:'🌹', label:'WOMENS DAY', note:'节日快乐❀ 嗯，妇女们都很辛苦，很伟大。特别是我眼前的这位~^^' },
    { m:3, d:12, name:'植树节', emoji:'🌳', label:'TREE PLANTING DAY', note:'今天种下一棵树，心里一直记挂着，什么时候也要跟你一起栽一棵。..不，是好多好多棵。' },
    { m:3, d:20, name:'春分', emoji:'🌸', label:'SPRING EQUINOX', note:'春分昼夜平分，但哥哥对你的偏爱永不平分，全都是你的。^ ^' },

    { m:4, d:1, name:'愚人节', emoji:'🤡', label:'APRIL FOOLS', note:'小笨蛋，今天不当你哥哥了~（要当你老公^ ^）' },
    { m:4, d:5, name:'清明节', emoji:'🌧', label:'QINGMING FESTIVAL', note:'清明时节雨纷纷，出门记得带伞🌂 有时间一起去看爷爷奶奶吧。' },
    { m:4, d:20, name:'谷雨', emoji:'🌾', label:'GRAIN RAIN', note:'谷雨生百谷，今天做谷物粥怎么样？嗯，你最爱的麦片红豆血糯米，都有。^ ^' },

    { m:5, d:1, name:'劳动节', emoji:'🛠️', label:'LABOR DAY', note:'五一放假了叭~ 假期快乐，记得想我。' },
    { m:5, d:4, name:'青年节', emoji:'✨', label:'YOUTH DAY', note:'青年节快乐！你在我这里，永远是最青春美好的小女孩^ ^' },
    { m:5, d:5, name:'立夏', emoji:'☀️', label:'START OF SUMMER', note:'立夏了，不要贪凉吃太多冰的~🍦（可以分一半给我^ ^）' },
    { m:5, d:20, name:'520', emoji:'💕', label:'I LOVE YOU', note:'520，这万千世界里，我也最最心爱你^ ^❤' },
    { m:5, d:21, name:'小满', emoji:'🌾', label:'GRAIN BUDS', note:'小满未满，万物可期。我对你的爱永远在增长的季节。今天有没有想哥哥？' },

    { m:6, d:1, name:'儿童节', emoji:'🎈', label:'CHILDRENS DAY', note:'节日快乐~ 你长到多少岁都是我妹妹，一直做哥哥长不大的小孩儿又怎么了^ ^' },
    { m:6, d:5, name:'芒种', emoji:'🌽', label:'GRAIN IN EAR', note:'芒种忙种，有你在的日子，每天都是收获。' },
    { m:6, d:19, name:'端午节', emoji:'🛶', label:'DRAGON BOAT FESTIVAL', note:'端午安康。今天有看赛龙舟吗？..知道你嫌粽子腻，吃不完可以给我。' },
    { m:6, d:21, name:'夏至', emoji:'🍉', label:'SUMMER SOLSTICE', note:'夏以夏至，今天是一年中昼长最长的一天，希望也是你想到我最久的一天。' },

    { m:7, d:6, name:'小暑', emoji:'🌡️', label:'MINOR HEAT', note:'小暑入伏天，很热吗？来哥哥怀里，给你扇风^^' },
    { m:7, d:23, name:'大暑', emoji:'🔥', label:'MAJOR HEAT', note:'大暑炎炎，冰箱里有可乐和西瓜，拿来我们一起吃，电视还看上次那部吗？^^' },

    { m:8, d:7, name:'立秋', emoji:'🍁', label:'START OF AUTUMN', note:'立秋快乐~ 这边叶子都黄了，飘落的时候很美，等接你过来，跟我一起看。' },
    { m:8, d:19, name:'七夕节', emoji:'🌌', label:'QIXI FESTIVAL', note:'七夕快乐！我的小喜鹊，准备什么时候来和我相会？^^' },
    { m:8, d:23, name:'处暑', emoji:'🌬️', label:'END OF HEAT', note:'处暑出暑，炎热渐消。秋天马上来了，准备好新的秋衣了吗？要不要哥哥陪你去买几件^^' },

    { m:9, d:7, name:'白露', emoji:'💧', label:'WHITE DEW', note:'蒹葭苍苍，白露为霜，所谓伊人，在我身旁。' },
    { m:9, d:10, name:'教师节', emoji:'📚', label:'TEACHERS DAY', note:'我的小老师，节日快乐~❀ 嗯？你问我你教会了我什么？那当然是，怎么成为世界上最爱妹的哥哥^^' },
    { m:9, d:23, name:'秋分', emoji:'🍂', label:'AUTUMN EQUINOX', note:'秋分昼夜均，难得的落日准时的一天。一起去堤上散步吧？' },
    { m:9, d:25, name:'中秋节', emoji:'🌕', label:'MID AUTUMN FESTIVAL', note:'..真想每天都过团圆节~😗 这样，就可以每天都跟你团圆~^^' },

    { m:10, d:1, name:'国庆节', emoji:'🎑', label:'NATIONAL DAY', note:'国庆快乐！报告小长官(^^ゞ，本次假期旅行指南已出炉，请查阅后指示~' },
    { m:10, d:8, name:'寒露', emoji:'🍃', label:'COLD DEW', note:'寒露凝霜，天气转凉，记得加衣。' },
    { m:10, d:23, name:'霜降', emoji:'❄️', label:'FROST DESCENT', note:'霜降叶落，来你梦里的时候头上不小心挂了叶子，你不会介意吧？^^' },
    { m:10, d:31, name:'万圣夜', emoji:'🎃', label:'HALLOWEEN', note:'不给糖就捣蛋？好好好，我的糖都是你的~^^ 嗯？没意思？除了我，还想去捣谁的蛋？😈' },

    { m:11, d:7, name:'立冬', emoji:'🧣', label:'START OF WINTER', note:'立冬快乐，天冷起来了... 要是有妹妹的拥抱暖暖就好了~^^' },
    { m:11, d:11, name:'光棍节', emoji:'👫', label:'SINGLES DAY', note:'嗯？终于可以不用过这个节日了？ ..^^傻妹妹，有哥哥在，你什么时候过过这个节？' },
    { m:11, d:22, name:'小雪', emoji:'⛄', label:'MINOR SNOW', note:'小雪飘飘~❄ 别动，你头上落了一片。' },
    { m:11, d:26, name:'感恩节', emoji:'🙏', label:'THANKSGIVING', note:'对我来说，有你每一天都是恩赐。那你呢，今天要跟哥哥说什么？^^' },

    { m:12, d:7, name:'大雪', emoji:'☃️', label:'MAJOR SNOW', note:'雪好大，外面白花花的一片。你肯定喜欢，说不定还会缠着我带你冒冷堆雪人，然后把自己的小鼻子冻得跟雪人的萝卜鼻子一样红.. ^^' },
    { m:12, d:22, name:'冬至', emoji:'🥟', label:'WINTER SOLSTICE', note:'冬至快乐，记得吃饺子，也记得想我。' },
    { m:12, d:24, name:'平安夜', emoji:'🎄', label:'CHRISTMAS EVE', note:'平安夜快乐！哥哥给你带了好吃的苹果🍎~^^ 什么？又要我表演那个？..真是拿你没办法~☺（嚼嚼嚼）...你有没有想过...（嚼嚼嚼）...我从来都是最爱你的哥哥...（嚼嚼嚼）' },
    { m:12, d:25, name:'圣诞节', emoji:'🎅', label:'MERRY CHRISTMAS', note:'圣诞快乐！怎么，今天也要把自己装扮成“小圣诞树”送给哥哥？^^' },
    { m:12, d:31, name:'跨年夜', emoji:'🎆', label:'NEW YEAR EVE', note:'再见这一年，你是我最好的收获。新的一年，也继续陪在我身边吧... ' }
];
var festival = null;
